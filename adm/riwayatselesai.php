                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h3 class="page-header">
                            Riwayat berkas yang telah selesai 
                        </h3>
                        <table id="example1" class="table table-bordered table-striped" style="width: 100%">
                            ...
                            <tr style="background-color: lightgreen">
                                ...
                                <th><center>Tanggal Diberikan Ke User</th></center>
                            ...
                            <?php
                                ...
                                echo '<tr><td colspan="8">Tidak ada data..</td><td>.</td><td>.</td><td>.</td><td>.</td><td>.</td><td>.</td></tr>';
                                }else{
                                    $no = 1;
                                    ...
                                    $caritanggal = mysql_query("SELECT * FROM tracking_berkas where no_notifikasi='$notif' && id_keterangan=12") or die(mysql_error());
                                    while($tanggal = mysql_fetch_assoc($caritanggal)){
                                        $t=date('d F Y -- H:i', strtotime($tanggal['tanggal']));
                                        echo '<td><center>'.$t.'</center></td>';
                                    }
                                     echo '<center><td><a href="info2.php?notifikasi='.$notif.'"><button type="button" class="btn btn-sm btn-primary">View Details</button></a>
                                    </center></td>';                                     
                                    $no++;
                                    }
