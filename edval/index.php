                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header">
                            <small><b>Berkas SPK masuk</b></small> 
                        </h1>
                        <ol class="breadcrumb">
                        </ol>
                            ...
                            <tr style="background-color: #fa8072">
                                ...
                                <th><center>Tanggal Masuk dari ADM</th></center>
                            ...
                            <?php
                                $query = mysql_query("SELECT * FROM berkas WHERE status=2") or die(mysql_error());
                                    ...
                                    $caritanggalmasuk = mysql_query("SELECT * FROM tracking_berkas where no_notifikasi='$notif' && id_keterangan=2") or die(mysql_error());
