                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header"><small><b>
                            Berkas SPK Yang Telah Selesai Diproses
                        </b></small></h1>
                        <h3><small><b>Berkas yang sudah difinalisasi</b></small></h3>
                            ...
                            <?php
                                ...
                                while($result = mysql_fetch_assoc($query)){                                 
                                    ...
                                    echo '<td><center>
                                    <a href="act/hapusfinalisasi.php?notifikasi='.$result['no_notifikasi'].'" onclick="return confirm(\'Batalkan finalisasi berkas ?)\')"><button type="button" class="btn btn-sm btn-danger">Cancel</button></a>
                                    </center></td>'; 
                                    echo '</tr>';
                                    $no++;
                                }
                        ...
                        <h3><small><b>Berkas yang sudah dikonfirmasi kembali ke meja ADM</b></small></h3>
                        <table id="example2" class="table table-bordered table-striped" style="width: 100%">
                            ...
                            <tr style="background-color: lightgreen">
                                ...
                                <th><center>Unit Kerja</th></center>
                                <th><center>Tanggal Finalisasi</th></center>
                                <th><center>Tanggal diterima ADM</th></center>
                                <th><center>Start</center></th>
                            </tr>
                            </thead>
                            <?php
                                ...
                                while($result = mysql_fetch_assoc($query)){                                 
                                    ...
                                    $konfirmasi = mysql_query("SELECT * FROM tracking_berkas where no_notifikasi='$notif' && id_keterangan=5") or die(mysql_error());
